 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://job.w1/", wsdlLocation = "http://127.0.0.1:8092/job1?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://job.w1/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8092/job1?wsdl");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://job.w1/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://job.w1/", "HelloImplPort"), Hello.class, features);
    }
